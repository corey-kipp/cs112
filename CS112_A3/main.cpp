...
void display(void)
{
  ...
  /*
  FORMAT (from stackoverflow link on messageboard)
  glPushMatrix();
  ...
  */
  glPushMatrix();
  setLightInteraction(); //lighting function in inputModule
  multVector(light_pos, m, initial_light_pos);
  multVector(light_pos, m, lightPosition);
...
int main(int argc, char **argv)
{
  ...
  filename = "C:/Users/Corey/Desktop/CS 112/CS112_A3/bunny.ply";
